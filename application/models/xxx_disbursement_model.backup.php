...
class Disbursement_model extends MY_Model{
	...
	public function list_page($budget_main_ID) {
		...
		$this->db->select('trn_disbursement.id, trn_disbursement.doc_number, trn_disbursement.doc_date, trn_disbursement.file_number, trn_disbursement.approve_id');
    ...
    public function display_plans_level($budget_main_ID, $start_date, $end_date) {
		$this->db->select('trn_mgt_plans.id, mst_plans.name');
        $this->db->join('trn_mgt_plans','trn_mgt_plans.id = trn_disbursement.mgt_plans_id');
		$this->db->join('mst_plans','mst_plans.id = trn_mgt_plans.plan_id');
     ...
     public function display_product_level($mgt_plans_ID) {
		$this->db->select('trn_mgt_product.id, mst_product.name');
        $this->db->join('trn_mgt_product','trn_mgt_product.id = trn_disbursement.mgt_product_id');
		$this->db->join('mst_product','mst_product.id = trn_mgt_product.product_id');
    ...
    function display_costs_level($plan_ID, $product_ID)
	{
		$this->db->select('trn_disbursement.costs_id, mst_costs.name');
		$this->db->join('mst_costs', 'mst_costs.id = trn_disbursement.costs_id');
        $this->db->where('trn_disbursement.mgt_plans_id =', $plan_ID);
        $this->db->where('trn_disbursement.mgt_product_id =', $product_ID);
        $this->db->group_by('trn_disbursement.costs_id');
		return $this->get();
	}
    
    function display_costs_group_level($plan_ID, $product_ID, $costs_ID)
	{
    ...
    function display_costs_type_level($plan_ID, $product_ID, $costs_group_ID)
	{
    ...
    function display_costs_lists_level($plan_ID, $product_ID, $costs_type_ID)
	{
